...
const translations = {
  en: {
    ...
    cancel: 'Cancel',
    delete: 'Delete',
    addUpdateRecord: 'Add DNSText Record',
    hint: 'Store a key/value pair on-chain on your .ton domain. Key: any name (e.g. avatar, bio, url), hashed with SHA-256. Value: any text, publicly readable.',
    keyLabel: 'Key',
  ...
  ru: {
    ...
    cancel: 'Отмена',
    delete: 'Удалить',
    addUpdateRecord: 'Добавить DNSText запись',
    hint: 'Сохраните пару ключ/значение on-chain на вашем .ton домене. Ключ: любое имя (напр. avatar, bio, url), хэшируется SHA-256. Значение: любой текст, виден всем.',
    keyLabel: 'Ключ',
