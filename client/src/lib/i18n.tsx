...
const translations = {
  en: {
    ...
    hint: 'DNS text records (dns_text#1eda) store arbitrary key/value pairs on-chain on your .ton domain. The key is a free-form name (e.g. email, url) hashed with SHA-256. The value is the associated text, publicly readable by anyone.',
    keyLabel: 'Key',
    keyPlaceholder: 'e.g. email',
    valueLabel: 'Value',
    valuePlaceholder: 'e.g. alice@example.com',
  ...
  ru: {
    ...
    hint: 'DNS text записи (dns_text#1eda) хранят произвольные пары ключ/значение on-chain на вашем .ton домене. Ключ — произвольное имя (напр. email, url), хэшируемое через SHA-256. Значение — связанный текст, видный всем.',
    keyLabel: 'Ключ',
    keyPlaceholder: 'напр. email',
    valueLabel: 'Значение',
    valuePlaceholder: 'напр. alice@example.com',
